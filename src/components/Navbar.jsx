...
const Navbar = () => {
  ...
  return (
    <nav
      className={`sm:px-6 px-6 w-full flex items-center py-5 fixed top-0 z-20 ${
      ...
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        <ul className="list-none hidden sm:flex flex-row gap-10">
          ...
          <li
            ...
            text-violet-800 border-1 rounded-lg border-violet-800 shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#6c28d9,0_0_15px_#08f,0_0_10px_#6c28d9]`}
          >
            <a href={Yelizaveta_Brus_Resume} target="_blank">
